...
parser.add_argument('--sampling_stop_iter', type=int, default=5)#50000)
...
if __name__ == "__main__":                
    ...
    load_radar_echo_df_path='InterDST_LSTM_L2_H64_2014to2019_pickday_checkpoint_finetune_modify_loss_d4_v2/2014to2019_pickday_60_test.pkl'
    ...
    if not load_radar_echo_df_path:
        ...
        if not os.path.isdir(save_path):
            os.makedirs(save_path)
        radar.saveRadarEchoDataFrame(path=save_path ,load_name_pkl='2014to2019_pickday_60_v2')   
...
#    save_path = 'save_2y3m_0918/'
    ...
    pretrained_model ='model_itr7_test_cost26.142784616221547_ssim0.5924431505587958.pkl'#None
    ...
    model_name ='model_loss' #'p1_model_itr5_test_cost9.519979798220062_ssim0.8119851203114509.pkl'
